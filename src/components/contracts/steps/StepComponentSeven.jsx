...
const StepComponentSeven = ({ setActiveIndex, contractInformation = defaultContractInfo, setContractInformation, toast, ...props }) => {
    ...
    return (
        <>
            {errorMessage ? (
                ...
                <iframe src={receiptBase64 + '#page=3'} width="100%" height="500px" title="PDF Preview"></iframe>
            )}
