...
export const StepComponentSix: React.FC<StepComponentSixProps> = ({
  ...
  const onChangeChild = (selectedChild: string) => {
    const childInfo = contractInformation.children.find(
      child => `${child.first_name} ${child.last_name}` === selectedChild
    );
        ...
        <div className='p-fluid'>
          ...
          <div className='mb-4'>
                ...
                <div className='flex gap-4'>
                  <label className='flex items-center gap-2'>
                    <Checkbox
                      ...
                      onChange={e =>
                        setValue('followMealProgram', e.checked ? true : null)
                      }
                      className='w-4 h-4'
                    />
                  ...
                  <label className='flex items-center gap-2'>
                    <Checkbox
                      ...
                      onChange={e =>
                        setValue('followMealProgram', e.checked ? false : null)
                      }
                      className='w-4 h-4'
                    />
            ...
            {errors.followMealProgram && (
              <small className='text-red-500 text-xs mt-1'>
                {errors.followMealProgram.message}
              </small>
            )}
          </div>
