...
export const Contracts: React.FC<ContractsProps> = () => {
  ...
  const renderContent = useMemo(() => {
    switch (activeIndex) {
      ...
      case 6:
        return <StepComponentSeven setLoadingInfo={setLoadingInfo} toast={toast} setActiveIndex={setActiveIndex} contractInformation={contractDone} setContractInformation={setContractInformation} />;
      default:
        return null;
    }
