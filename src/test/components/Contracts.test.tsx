      ...
      <button
        onClick={() =>
          setContractInformation({
            ...contractInformation,
            schedule: [
              { day: 'Monday', check_in: '08:00', check_out: '17:00' },
            ],
          })
        }
      >
...
vi.mock(
  '../../components/contracts/steps/medical/MedicalInformationForm',
  () => ({
...
vi.mock(
  '../../components/contracts/steps/medical/FormulaInformationForm',
  () => ({
...
vi.mock(
  '../../components/contracts/steps/medical/PermissionsInformationForm',
  () => ({
...
describe('Contracts Component', () => {
  ...
  describe('Step Navigation', () => {
    it('navigates to different steps when step buttons are clicked', async () => {
      ...
      expect(
        screen.queryByTestId('step-component-one')
  ...
  describe('Medical Information Steps', () => {
    it('renders medical information form correctly', async () => {
      ...
      expect(
        screen.getByTestId('medical-information-form')
      ).toBeInTheDocument();
    ...
    it('renders formula information form correctly', async () => {
      ...
      expect(
        screen.getByTestId('formula-information-form')
      ).toBeInTheDocument();
    ...
    it('renders permissions information form correctly', async () => {
      ...
      expect(
        screen.getByTestId('permissions-information-form')
      ).toBeInTheDocument();
  ...
  describe('Contract Generation', () => {
    it('renders contract generator step correctly', async () => {
      ...
      expect(
        screen.getByText('Step Seven - Contract Generator')
      ).toBeInTheDocument();
    });
  });
